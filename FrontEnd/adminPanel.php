	...
	<div class="container-fluid  backimage vh-100" >
		<div class="row d-flex" style="height: 50px; background-color:#121b30; color:white ; font-size: 24px;">
			<div class="container d-flex">
				...
				<div class="col d-flex justify-content-end"><p class="p1"><a href="index.php">MovieLK</a> </p><img src="src/Logo.png" style="height:50px;width:50px; text-decoration:none"></div>
			</div>
		</div>
<!-- ------------------------------------------
 		siderbar
