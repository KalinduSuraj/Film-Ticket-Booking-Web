						...
						<div class="col d-flex">
							<table id="forTime">
								<tr style="align-items: center; align-content: center;">
									...
									<td ><button type="button" id='time2' class="btn btn-outline-info btnStyle" onclick="timeClick(this.id)"
									value="01.00 PM">01.00 PM </button></td>
					...
					-------------------	!-->
						...
						<div class="col container1 justify-content-center">
							...
							<div class="row d-flex justify-content-center">
								<br>
								<div class="d-flex trapezoid"><p style="margin-top: 5px;margin-left: 60px;color: black;">Screen</p></div>
							</div>
